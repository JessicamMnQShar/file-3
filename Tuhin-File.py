...
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mTUHIN AHMMED 
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/c/TUHIN AHMMED")
		exit()
	else:
		os.system("https://youtube.com/c/TUHIN AHMMED")
		exit()
...
def setting():
	...
	if fast in ['y','Y']:
		...
		os.system("xdg-open https://youtube.com/c/TUHIN AHMMEDTechnologychannel")
		exit()
